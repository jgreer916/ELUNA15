Ext.define('ELUNA2015.view.MultiSelect', {
    ...
    getTabletPicker: function() {
        ...
        if (!me.listPanel) {
            me.listPanel = Ext.create('Ext.Panel', Ext.apply({
                ...
                layout: 'fit',
                hideOnMaskTap: true,
                width: Ext.os.is.Phone ? '18em' : '22em',
                height: (Ext.os.is.BlackBerry && Ext.os.version.getMajor() === 10) ? '12em' : (Ext.os.is.Phone ? '18.5em' : '22em'),
                items: [{
                    xtype: 'list',
                    mode: listMode,
                    store: me.getStore(),
...
//        listPanel.showBy(Ext.getComponent('sessionsfilterbutton'), (Ext.os.is.BlackBerry && Ext.os.version.getMajor() === 10) ? 't-b' : 'tr-tl');
